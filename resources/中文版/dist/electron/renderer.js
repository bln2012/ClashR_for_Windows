			...
			}), Object(_.mapGetters)(["resourcesPath", "filesPath"]),
			{
				...
				statusHint: function()
				{
					return 0 < this.pkgDownloadProgress && 1 > this.pkgDownloadProgress ? "Download progress: " + (100 * this.pkgDownloadProgress)
						.toFixed(2) + "%" : this.clashStatus === k.a.CONNECTED ? "已连接" : this.clashStatus === k.a.DISCONNECTED ? "未连接" : this.clashStatus === k.a.INSTALLING_TAP ? "安装中" : this.clashStatus === k.a.UNINSTALLING_TAP ? "Uninstalling" : void 0
				},
				statusIcon: function()
				{
					return {
					...
					return y()(g.a.mark((function t()
					{
						...
						return g.a.wrap((function(t)
						{
							for(;;) switch (t.prev = t.next)
							{
								...
								case 40:
									N = t.sent, L = N.status, M = N.data, a = 204 === L, R = M.message, i = R || "配置文件切换失败，错误：" + L, t.next = 55;
									break;
								case 48:
