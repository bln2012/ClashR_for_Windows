module.exports = function(e) {
	...
	var r = n(16),
		...
		K = function(e, t, n) {
			return e === z && K(U, t, n), x(e), t = w(t, !0), x(n), a(F, t) ? (n.enumerable ? (a(e, L) && e[L][t] && (e[L][t] = !1), n = k(n, {
				enumerable: _(0, !1)
			})) : (!a(e, L) && E(e, L, _(1, {})), e[L][t] = !0), V(e, t, n)) : E(e, t, n)
		},
		Y = function(e, t) {
			x(e);
	...
	t.default = {
		...
		mutations: {
			...
			DELETE_PROFILE: function(e, t) {
				...
				r.splice(n, 1), e.profiles = o()({}, e.profiles, {
					files: r
				})
			},
			APPEND_PROFILE: function(e, t) {
				...
				if(n) {
					...
					r.push(n), e.profiles = o()({}, e.profiles, {
						files: r
					})
				}
			},
	...
	function pe(e, t, n, r) {
		...
		i ? (n = n || {}, r && (n = x(x({}, r), n)), a = i(n) || t) : a = this.$slots[e] || t;
		var o = n && n.slot;
	...
	function Ae(e, t, n, o, c) {
		if(!r(e)) {
			...
			if(s(e) && (e = d.extend(e)), "function" == typeof e) {
				...
				t = t || {}, et(e), a(t.model) && function(e, t) {
	...
	function He(e, t, n) {
		Ta = e, te(t, n || {}, Fe, Ue, ze, e), Ta = void 0
	}
		...
		e.extend = function(e) {
			...
			return (o.prototype = Object.create(n.prototype))
				.constructor = o, o.cid = t++, o.options = z(n.options, e), o.super = n, o.options.props && function(e) {
					...
					o[e] = n[e]
				})), i && (o.options.components[i] = o), o.superOptions = n.options, o.extendOptions = e, o.sealedOptions = x({}, o.options), a[r] = o, o
		}
	}
	...
	function bt(e, t) {
		...
		if(!(a(n) && !1 === n.Ctor.options.inheritAttrs || r(e.data.attrs) && r(t.data.attrs))) {
			var i, o, s = t.elm,
				c = e.data.attrs || {},
				d = t.data.attrs || {};
			for(i in a(d.__ob__) && (d = t.data.attrs = x({}, d)), d) o = d[i], c[i] !== o && wt(s, i, o);
	...
	function Jt(e, t) {
		if(!r(e.data.domProps) || !r(t.data.domProps)) {
			var n, i, o = t.elm,
				s = e.data.domProps || {},
				c = t.data.domProps || {};
			for(n in a(c.__ob__) && (c = t.data.domProps = x({}, c)), s) n in c || (o[n] = "");
			for(n in c) {
	...
	var eo, to, no, ro, ao, io, oo, so, co, lo, uo, fo, po = /\{\{((?:.|\r?\n)+?)\}\}/g,
		...
		ds = function(e) {
			this.options = e, this.warn = e.warn || Pt, this.transforms = $t(e.modules, "transformCode"), this.dataGenFns = $t(e.modules, "genData"), this.directives = x(x({}, cs), e.directives);
	...
	var V = B.exports,
		W = {
			...
			methods: h()({}, Object(v.mapMutations)({
	...
	var oe = {
			...
			methods: w()({}, Object(_.mapMutations)({
				changeTheme: "CHANGE_THEME",
						...
						return g.a.wrap((function(t) {
							for(;;) switch (t.prev = t.next) {
								...
								case 12:
									...
									break;
								case 29:
									return h = w()({}, u, f), t.abrupt("break", 38);
								case 31:
								...
								case 38:
									return "darwin" !== process.platform && (C = (k = h)
										.dns, S = void 0 === C ? {} : C, P = k.experimental, $ = void 0 === P ? {} : P, T = S.enable, E = void 0 !== T && T, A = S.listen, O = ["", "0.0.0.0"], S && E && A && (j = A.split(":")[0].trim(), D = A.split(":")[1].trim(), O.includes(j) && "53" === D && (d = !0, void 0 === $["interface-name"] && ("" == e.defaultInterfaceName ? d = !1 : h = w()({}, h, {
											experimental: w()({}, $, {
						...
						return g.a.wrap((function(r) {
							for(;;) switch (r.prev = r.next) {
								...
								case 7:
									...
									if(a = t.confData["cfw-conn-break-strategy"], i = (void 0 === a ? {} : a)
										.mode, !(void 0 !== i && i)) {
										r.next = 13;
										break
									}
				...
				initConfigFolder: function() {
					...
					} catch (t) {} else G.info("first luanch, creating config.yaml..."), W.a.copyFileSync(t, n);
				...
				setupConfigWatcher: function() {
					...
					if(this.clashPath && !this.configFileWatcher) {
						...
						this.configFileWatcher = W.a.watch(t, {}, n)
					}
				},
					...
					return u()(d.a.mark((function t() {
						...
						return d.a.wrap((function(t) {
							for(;;) switch (t.prev = t.next) {
								...
								case 6:
									a = t.sent, i = U()(a, 2), o = i[0].data, s = void 0 === o ? {} : o, c = i[1].data, l = (c = void 0 === c ? {} : c)
	...
	var J = Y.exports,
		...
		ne = {
			...
			methods: p()({}, Object(x.mapMutations)({
				...
				handleEditItem: function(e) {
					...
					return u()(d.a.mark((function n() {
						...
						return d.a.wrap((function(n) {
							for(;;) switch (n.prev = n.next) {
								case 0:
									return r = p()({}, t.pfs.files[e]), "Edit profile information", a = r.interval, i = void 0 === a ? 0 : a, o = [{
										key: "name",
										name: "Name",
										required: !0,
										value: r.name
					...
					return u()(d.a.mark((function n() {
						...
						return d.a.wrap((function(n) {
							for(;;) switch (n.prev = n.next) {
								...
								case 2:
									if(r = t.confData["cfw-conn-break-strategy"], a = (void 0 === r ? {} : r)
										.profile, !(void 0 !== a && a)) {
										n.next = 7;
										break
									}
							...
							for(;;) switch (n.prev = n.next) {
								...
								case 8:
									return n.prev = 8, s = new te((function(e) {
										t.downlodingUrls = p()({}, t.downlodingUrls, i()({}, a, e))
					...
					return u()(d.a.mark((function r() {
						...
						return d.a.wrap((function(r) {
							for(;;) switch (r.prev = r.next) {
								...
								case 3:
									return a = r.sent, i = a.status, o = a.headers, s = void 0 === o ? {} : o, c = a.data, r.next = 10, t.$parseProfile(e, c, t.confData);
								case 10:
				...
				setupWatcher: function() {
					...
					this.fileWatcher = X.watch(Z.join(this.profilesPath), {}, t)
				},
				...
				handleHealthCheck: function(e, t) {
					...
					return y()(g.a.mark((function r() {
						...
						return g.a.wrap((function(r) {
							for(;;) switch (r.prev = r.next) {
								case 0:
									if(a = e.name, n.$set(n.providers, t, w()({}, e, {
										isChecking: !0
									})), !a) {
										r.next = 13;
										break
						...
						return g.a.wrap((function(t) {
							for(;;) switch (t.prev = t.next) {
								...
								case 2:
									...
									for(o = i.providers, s = void 0 === o ? {} : o, c = [], l = !0, u = !1, f = void 0, t.prev = 12, h = p()(T()(s)); !(l = (v = h.next())
										.done); l = !0) m = v.value, x = d()(m, 2), x[0], y = x[1], b = y.vehicleType, ["File", "HTTP"].includes(b) && c.push(w()({}, y, {
										isChecking: !1,
										isUpdating: !1
									}));
									t.next = 20;
							...
							for(;;) switch (a.prev = a.next) {
								...
								case 5:
									...
									if(n.proxies.find((function(t) {
										...
										})), s = n.confData["cfw-conn-break-strategy"], c = (void 0 === s ? {} : s)
					...
					return y()(g.a.mark((function t() {
						...
						return g.a.wrap((function(t) {
							for(;;) switch (t.prev = t.next) {
								...
								case 3:
									r = t.sent, a = d()(r, 2), o = a[0], c = a[1], l = c.data, f = (void 0 === l ? {} : l)
										.providers, p = void 0 === f ? {} : f, h = o.data.proxies, v = h.GLOBAL.all, e.viewData = h, e.proxies = i()(h)
										.map((function(t) {
